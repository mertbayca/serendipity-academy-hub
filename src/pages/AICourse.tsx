    ...
    <section className="relative pt-36 pb-20 bg-blue-50 overflow-hidden">
      ...
      <div className="absolute top-16 right-6 z-[100]">
        <div className="flex items-center space-x-2 bg-white/90 backdrop-blur-sm rounded-full px-3 py-1.5 shadow-sm border border-blue-100">
          <a href="/ai-course" className="flex items-center space-x-1.5 text-blue-900 font-bold">
            <img src="/assets/flags/gb.svg" alt="English" className="w-4 h-4" />
            <span>EN</span>
          </a>
          <span className="text-blue-900/50">|</span>
          <a href="/ai-course/de" className="flex items-center space-x-1.5 text-blue-900 hover:text-blue-700 transition-colors">
